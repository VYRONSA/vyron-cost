    ...
    <VyronCostAiShell hidePageHeader title="Demo Data" subtitle="Use the supplied SQL seed file to populate a realistic pie company demo.">
      <section className="grid gap-5 md:grid-cols-3">
        {[
          ...
          <div key={title} className="rounded-[2rem] bg-white p-6 shadow-[0_18px_50px_rgba(22,58,72,0.08)]">
      ...
      <section className="mt-6 rounded-[2rem] bg-white p-6 shadow-[0_18px_50px_rgba(22,58,72,0.08)]">
