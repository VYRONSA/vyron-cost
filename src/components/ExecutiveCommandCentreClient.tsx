  ...
  return (
    <section className="grid gap-8">
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        ...
        <CommandCentreCard title="Inventory Command Centre" subtitle="Valuation · stock risk" href="/inventory-intelligence" accent="bg-gradient-to-br from-emerald-900 to-[#07110d]">
      ...
      <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
          <h3 className="text-xl font-black text-[#07110d]">Executive risk heatmap</h3>
      ...
      {supplierIntelligence ? (
        <section className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-3">
            ...
            <div>
              <div className="text-[10px] font-black uppercase text-emerald-600">Top savings</div>
              <ul className="mt-2 space-y-2 text-sm font-bold">
