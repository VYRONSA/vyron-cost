...
check("register holds 86 assets", all.length === 86, String(all.length));
check("77 validation assets", counts.A + counts.B + counts.C + counts.D === 77, String(counts.A + counts.B + counts.C + counts.D));
