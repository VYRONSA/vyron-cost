export const MOBILE_TOKENS = {
  surface: {
    ...
    shellBackdrop:
      "bg-[linear-gradient(115deg,transparent_0%,rgba(22,58,72,0.03)_36%,transparent_72%),radial-gradient(circle_at_82%_8%,rgba(44,90,107,0.04),transparent_24%),radial-gradient(circle_at_24%_92%,rgba(22,58,72,0.03),transparent_32%)] opacity-[0.85]",
  },
  spacing: {
    pageX: "px-4 sm:px-5",
    stack: "space-y-4",
  ...
  text: {
    title: "volora-display text-[2.15rem] font-bold tracking-[-0.03em] text-[#0B202B]",
    heading: "volora-display text-[1.38rem] font-bold tracking-[-0.02em] text-[#0B202B]",
  ...
  icon: {
    dark: "flex h-12 w-12 items-center justify-center rounded-2xl vyron-grad-surface text-white shadow-[0_12px_28px_rgba(6,23,34,0.22)]",
    light: "flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-slate-900 shadow-[0_8px_20px_rgba(11,32,43,0.08)]",
  },
  touch: {
    pressable: "transition duration-200 ease-out active:translate-y-[1px] active:scale-[0.985]",
    liftHover: "hover:-translate-y-1 hover:shadow-[0_24px_48px_rgba(11,32,43,0.14)]",
  },
} as const;
...
export const MOBILE_TYPOGRAPHY = {
  // VOLORA body face (Inter via next/font); headings add the display face.
  family: "font-sans",
};
