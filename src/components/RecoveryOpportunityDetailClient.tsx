    ...
    >
      <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
            <div className="space-y-6">
              ...
              <div className="rounded-[2rem] border border-[#A3E635]/25 bg-[#A3E635]/10 p-6">
                ...
                <div className="mt-4 grid gap-3 md:grid-cols-2">
                  <div className="rounded-xl bg-white p-4">
                    ...
                    <div className="mt-1 text-2xl font-black text-[#65A30D]">{formatMoney(detail.monthly_saving)}</div>
                  </div>
                  <div className="rounded-xl bg-white p-4">
                    <div className="text-xs font-black uppercase text-slate-400">Annual value</div>
                    <div className="mt-1 text-2xl font-black text-[#65A30D]">{formatMoney(detail.annual_saving)}</div>
                  ...
                  <div className="mt-4 space-y-2">
                    {detail.productsAffected.map((product) => (
                      <Link
                        key={product.id}
                        href={product.href}
                        className="flex items-center justify-between rounded-xl bg-slate-50 px-4 py-3 transition hover:bg-[#A3E635]/10"
                      >
            ...
            <aside className="space-y-5">
              <div className="rounded-[2rem] bg-[#08111A] p-6 text-white">
                ...
                <div className="mt-3 text-4xl font-black text-[#A3E635]">{formatMoney(detail.annual_saving)}</div>
              ...
              <div className="rounded-[2rem] border border-white bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 grid gap-3">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#A3E635]/30 bg-[#24183F] px-4 py-3 text-sm font-black text-[#F8FAFC]"
                  >
                ...
                {message ? (
                  <div className="mt-4 rounded-xl border border-[#A3E635]/20 bg-[#A3E635]/10 px-4 py-3 text-sm font-black text-[#65A30D]">{message}</div>
                ) : null}
              </div>
            </aside>
          </section>
