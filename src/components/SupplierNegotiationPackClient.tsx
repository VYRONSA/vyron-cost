  ...
  return (
    <section className="grid gap-6">
      <div className="rounded-[2rem] bg-[#07110d] p-6 text-white">
        ...
        <button onClick={downloadPack} className="mt-5 inline-flex items-center gap-2 rounded-2xl bg-emerald-400 px-5 py-3 text-sm font-black text-[#07110d]">
        ...
        {priority.map((supplier) => (
          <div key={supplier.id} className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                <h3 className="text-2xl font-black text-[#07110d]">{supplier.supplier_name}</h3>
              ...
              <div className="text-right">
                <div className="text-3xl font-black text-emerald-700">{formatSupplierSpend(supplier.negotiation_opportunity)}</div>
