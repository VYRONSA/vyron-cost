          ...
          {filtered.map((ingredient) => {
            ...
            return (
              <div key={ingredient.id} className="grid grid-cols-8 items-center border-t border-slate-100 px-5 py-4 text-sm">
                <div className="font-black text-[#07110d]">{ingredient.ingredient_name}</div>
                ...
                <div className="font-black text-emerald-700">{formatMoney(Number(ingredient.true_unit_cost))}</div>
