    ...
    >
      <section className="grid gap-6">
        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
          ...
          <div className="mt-3 text-4xl font-black text-[#7E22CE]">{formatSupplierSpend(totalSaving)}</div>
        </div>
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
        ...
        <div className="rounded-[2rem] bg-[#07110d] p-6 text-white shadow-[0_18px_55px_rgba(6,20,14,0.24)]">
          <div className="text-xs font-black uppercase tracking-[0.16em] text-[#A855F7]">Rule</div>
        ...
        {benchmarks.map((row) => (
          <Link key={row.id} href={row.href} className="grid grid-cols-7 items-center border-t border-slate-100 px-5 py-5 text-sm transition hover:bg-[#A855F7]/10">
            ...
            <div className="font-black text-[#7E22CE]">{formatSupplierSpend(row.saving)}</div>
