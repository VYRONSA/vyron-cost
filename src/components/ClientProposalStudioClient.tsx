...
export default function ClientProposalStudioClient({ snapshot }: { snapshot: LaunchReadinessSnapshot }) {
  function downloadProposal() {
    const text = [
      "VOLORA — Handcrafted Foods Proposal",
      "",
  ...
  return (
    <VyronPremiumPageShell
      config={{
        ...
        subtitle: "Premium VOLORA workflow for client proposal studio.",
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_0.75fr]">
            <div className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(11,32,43,0.06)]">
              ...
              <div className="mt-5 space-y-4 text-sm font-semibold leading-7 text-slate-600">
                <p>VOLORA will help Handcrafted Foods identify product margin leakage, supplier price movement, invoice risk and recoverable profit.</p>
