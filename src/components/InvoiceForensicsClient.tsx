        ...
        <div className="min-w-[1180px]">
          ...
          {paged.map((row) => (
            <div key={row.id} className="grid grid-cols-9 items-center border-t border-slate-100 px-5 py-5 text-sm">
              <div className="font-black text-[#07110d]">{row.invoice_number}</div>
              ...
              <div>
                <Link href="/invoice-centre" className="rounded-full bg-emerald-50 px-3 py-2 text-xs font-black text-emerald-700">
                  Open
                </Link>
              </div>
            </div>
