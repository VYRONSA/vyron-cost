    ...
    >
      <section className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {sections.map((section) => (
              ...
              >
                <div className="text-xs font-black uppercase tracking-[0.2em] text-[#1D4ED8]">{section.title}</div>
            ...
            <div className="rounded-[2rem] bg-[#07110d] p-6 text-white md:col-span-2 xl:col-span-3">
              <div className="text-xs font-black uppercase tracking-[0.2em] text-[#3B82F6]">Food manufacturing intelligence</div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link href="/product-profitability" className="rounded-full bg-[#3B82F6]/12 px-4 py-2 text-xs font-black text-[#3B82F6]">
                  Product GP
                </Link>
                <Link href="/yield-engine" className="rounded-full bg-[#3B82F6]/12 px-4 py-2 text-xs font-black text-[#3B82F6]">
                  Yield Engine
                </Link>
