  ...
  return (
    <VyronPremiumPageShell
      config={{
        ...
        subtitle: "Premium VOLORA workflow for stock impact simulator.",
    ...
    >
      <section className="grid gap-6 xl:grid-cols-[0.75fr_1.25fr]">
            ...
            <div className="rounded-[2rem] bg-[#061722] p-6 text-white shadow-[0_18px_55px_rgba(6,20,14,0.24)]">
              <div className="text-xs font-black uppercase tracking-[0.16em] text-[#2C5A6B]">Stock Impact</div>
              <div className="mt-6 grid gap-5 md:grid-cols-3">
                ...
                <div className="rounded-3xl bg-white/10 p-5">
                  ...
                  <div className="mt-2 text-3xl font-black text-[#2C5A6B]">{money(annual)}</div>
                </div>
              </div>
            </div>
          </section>
