...
export default function EmailInvoiceInboxClient() {
  ...
  return (
    <section className="grid gap-6">
      <div className="rounded-[2rem] border border-blue-100 bg-gradient-to-br from-blue-700 to-blue-800 p-6 text-white shadow-[0_18px_55px_rgba(22,58,72,0.24)]">
        <MailCheck size={34} className="text-blue-200" />
        ...
        <p className="mt-3 max-w-3xl text-sm font-semibold leading-7 text-blue-100">
          Supplier invoices emailed to VOLORA are queued here. Upload attachments to run extraction, supplier
        ...
        <button
          ...
          className="mt-5 inline-flex cursor-pointer items-center gap-2 rounded-2xl bg-white px-5 py-3 text-sm font-black text-blue-800 disabled:opacity-60"
        >
          <UploadCloud size={17} />
        ...
        />
        {message ? <div className="mt-3 text-sm font-black text-blue-200">{message}</div> : null}
        <Link href="/document-intelligence" className="mt-4 inline-block text-xs font-black uppercase text-blue-200 hover:underline">
      ...
      <div className="overflow-x-auto rounded-[2rem] border border-blue-100 bg-white shadow-[0_18px_50px_rgba(22,58,72,0.08)]">
        ...
        <div className="grid grid-cols-5 bg-blue-800 px-5 py-4 text-xs font-black uppercase tracking-[0.16em] text-blue-100">
          <div>Source</div>
          <div>File</div>
          <div>Supplier</div>
          <div>Status</div>
        ...
        {loading ? (
          ...
          <div className="px-5 py-8 text-sm font-bold text-slate-500">
            ...
            <Link href="/document-intelligence" className="text-blue-700 underline">
          ...
          queue.map((row) => (
            <Link
              ...
              className="grid grid-cols-5 items-center border-t border-slate-100 px-5 py-5 text-sm transition hover:bg-blue-50/60"
            >
              ...
              <div className="font-black text-blue-700">{statusLabel(row.status)}</div>
