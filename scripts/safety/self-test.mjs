...
check("register holds 62 assets", all.length === 62, String(all.length));
check("58 validation assets", counts.A + counts.B + counts.C + counts.D === 58, String(counts.A + counts.B + counts.C + counts.D));
