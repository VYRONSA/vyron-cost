  ...
  return (
    <main className={`min-h-screen ${M.page}`}>
      <div className="pointer-events-none fixed inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_12%_8%,rgba(22,58,72,0.05),transparent_42%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_88%_12%,rgba(44,90,107,0.04),transparent_38%)]" />
      </div>
