    ...
    <section className="grid gap-6">
      <section className="grid gap-5 md:grid-cols-3">
        ...
        <div className="rounded-[2rem] bg-emerald-50 p-6">
          <div className="text-xs font-black uppercase tracking-[0.16em] text-emerald-700">Recoverable</div>
          <div className="mt-3 text-4xl font-black text-emerald-700">{money(totalWaste * 0.65)}</div>
        </div>
        <div className="rounded-[2rem] bg-[#07110d] p-6 text-white">
          <div className="text-xs font-black uppercase tracking-[0.16em] text-emerald-300">Target</div>
        ...
        {branches.map((branch) => (
          <div key={branch.id} className="rounded-[2rem] bg-white p-5 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
            <div className="flex justify-between gap-4">
              <div>
                <div className="text-xl font-black text-[#07110d]">{branch.branch_name}</div>
