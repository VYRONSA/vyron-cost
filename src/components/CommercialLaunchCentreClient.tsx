  ...
  return (
    <section className="grid gap-6">
      <div className="rounded-[2rem] bg-[#07110d] p-6 text-white shadow-[0_18px_55px_rgba(6,20,14,0.24)]">
        <Rocket size={34} className="text-emerald-300" />
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-3">
          <div className="rounded-3xl bg-white/10 p-5">
            ...
            <div className="mt-2 text-5xl font-black text-emerald-300">{snapshot.readinessScore}%</div>
          </div>
          <div className="rounded-3xl bg-white/10 p-5">
      ...
      <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        {checks.map(([label, value, href]) => (
          <Link key={String(label)} href={String(href)} className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)] transition hover:bg-emerald-50">
            ...
            <div className="mt-3 text-4xl font-black text-[#07110d]">{String(value)}</div>
