  ...
  return (
    <VyronPremiumPageShell
      config={{
        ...
        subtitle: "Premium VOLORA workflow for purchase order intelligence.",
      ...
      <section className="grid gap-6">
            <section className="grid gap-5 md:grid-cols-3">
              ...
              <div className="rounded-[2rem] bg-[#061722] p-6 text-white shadow-[0_18px_55px_rgba(6,20,14,0.24)]">
                <div className="text-xs font-black uppercase tracking-[0.16em] text-[#2C5A6B]">Control Rule</div>
            ...
            <div className="overflow-hidden rounded-[2rem] bg-white shadow-[0_10px_40px_rgba(11,32,43,0.06)]">
              ...
              {risks.map((row) => (
                <div key={row.id} className="grid grid-cols-7 items-center border-t border-slate-100 px-5 py-5 text-sm">
                  <Link href="/purchase-orders" className="font-black text-[#163A48]">{row.supplier_name}</Link>
