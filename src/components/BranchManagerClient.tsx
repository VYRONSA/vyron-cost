    ...
    <section className="grid gap-6 xl:grid-cols-[0.8fr_1.5fr]">
      <div className="rounded-[2rem] border border-white bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-black text-[#07110d]">Add Branch</h2>
        ...
        <div className="grid gap-4">
          {[
            ...
            <label key={field} className="text-sm font-black text-slate-600">
              {label}
              <input
                className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3 font-medium outline-none focus:border-emerald-400"
          ...
          <button
            type="button"
            onClick={addBranch}
            className="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-500 px-5 py-4 text-sm font-black text-[#07110d] transition hover:bg-emerald-400"
          >
            <Plus size={18} />
            Add Branch
          </button>
      ...
      <div className="rounded-[2rem] border border-white bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
        <h2 className="text-2xl font-black text-[#07110d]">Branch Network</h2>

        <div className="mt-5 rounded-[1.5rem] border border-emerald-100 bg-emerald-50/40 px-4 py-3">
          <input
            value={search}
            ...
            <div key={branch.id} className="rounded-[1.5rem] border border-slate-100 bg-white p-5 shadow-sm">
              <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                <div>
                  ...
                  <h3 className="mt-3 text-xl font-black text-[#07110d]">{branch.branch_name}</h3>
