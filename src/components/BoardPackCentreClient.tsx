    ...
    >
      <section className="grid gap-6 xl:grid-cols-[1fr_0.7fr]">
            ...
            <div className="rounded-[2rem] bg-[#07110d] p-6 text-white">
              ...
              <button onClick={downloadPack} className="mt-6 inline-flex items-center gap-2 rounded-2xl border border-[#A3E635]/30 bg-[#24183F] px-5 py-3 text-sm font-black text-[#F8FAFC]">
