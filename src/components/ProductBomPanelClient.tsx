  ...
  return (
    <div className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
        ...
        <div className="rounded-xl bg-slate-50 px-4 py-3">
          ...
          <div className="mt-1 font-black">
            {summary.linkedRecipe ? (
              <Link href={`/recipes/${summary.linkedRecipe.id}`} className="text-emerald-700">
      ...
      <div className="mt-4 flex flex-wrap gap-3">
        <button type="button" onClick={updateFromBom} className="rounded-xl bg-emerald-500 px-4 py-2 text-xs font-black text-[#07110d]">
      ...
      {message ? <div className="mt-3 text-sm font-black text-emerald-700">{message}</div> : null}
    </div>
  );
}
