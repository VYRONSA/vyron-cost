  ...
  return (
    ...
    >
      <section className="grid gap-5 md:grid-cols-4">
        ...
        <div className="rounded-[2rem] bg-[var(--vyron-warning-bg)] p-6 shadow-sm">
          <div className="text-xs font-black uppercase tracking-[0.14em] text-[var(--vyron-warning-fg)]">New Price</div>
          <div className="mt-2 text-2xl font-black text-[var(--vyron-warning-fg)]">{money(risk.new_price)}</div>
        </div>
        <div className="rounded-[2rem] bg-white p-6 shadow-sm">
