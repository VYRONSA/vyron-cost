    ...
    >
      <section className="grid gap-6">
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div className="rounded-[2rem] border border-[#A3E635]/25 bg-[#A3E635]/10/60 p-6">
                ...
                <div className="mt-4 space-y-3">
                  {highest.map((row) => (
                    <div key={row.id} className="flex items-center justify-between rounded-2xl bg-white px-4 py-3">
                      <div className="font-black text-[#F8FAFC]">{row.product_name}</div>
                      <div className="font-black text-[#65A30D]">{Number(row.actual_gp || 0).toFixed(1)}% GP</div>
                    </div>
                  ))}
                </div>
              </div>
                ...
                {paged.map((row) => (
                  <div key={row.id} className="grid grid-cols-9 items-center border-t border-slate-100 px-5 py-5 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Link href="/recovery-opportunities" className="text-[#65A30D]">
