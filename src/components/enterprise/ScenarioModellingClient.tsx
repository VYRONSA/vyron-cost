    ...
    <section className="grid gap-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-2xl bg-white p-5 shadow-sm">
          ...
          <div className={impact.gpChangePts < 0 ? "text-red-600 font-bold" : "text-emerald-600 font-bold"}>
            {impact.gpChangePts} pts
          </div>
        </div>
        <div className="rounded-2xl bg-emerald-50 p-5">
          <div className="text-xs font-black uppercase text-emerald-700">Recovery</div>
      ...
      <div className="rounded-[2rem] bg-[#07110d] p-6 text-white">
        <div className="text-xs font-black uppercase text-emerald-300">Annual profit impact</div>
