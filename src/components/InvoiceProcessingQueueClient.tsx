    ...
    <section className="grid gap-6">
      ...
      <div className="rounded-[2rem] bg-white p-5 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
        <div className="flex items-center gap-3 rounded-[1.5rem] border border-emerald-100 bg-emerald-50/40 px-4 py-3">
          ...
          />
          <div className="rounded-full bg-[#07110d] px-4 py-2 text-xs font-black text-emerald-300">{filtered.length} invoices</div>
        </div>
      </div>
          ...
          {filtered.map((invoice) => {
            ...
            return (
              <div key={invoice.id} className="grid grid-cols-8 items-center border-t border-slate-100 px-5 py-5 text-sm">
                <div className="font-black text-[#07110d]">{invoice.supplier_name}</div>
      ...
      <div className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
        <h2 className="text-2xl font-black text-[#07110d]">Processing Rules</h2>
