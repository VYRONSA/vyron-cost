...
const VARIANT_CLASS: Record<PremiumMobileButtonVariant, string> = {
  ...
  secondary: "border border-slate-200 bg-white text-slate-900 shadow-[0_10px_24px_rgba(11,32,43,0.07)]",
  danger: "border border-rose-200 bg-rose-50 text-rose-700 shadow-[0_10px_24px_rgba(44,90,107,0.14)]",
