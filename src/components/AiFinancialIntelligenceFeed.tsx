...
const signalStyles = {
  ...
  recover: "border-[#BFDBFE] bg-[#F0FDF4]",
        ...
        <div className="border-b border-[#E2E8F0] px-8 py-6">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex gap-4">
              ...
              <div className="rounded-2xl border border-[#BFDBFE] bg-[#F0FDF4] px-5 py-4">
                <div className="text-[10px] font-black uppercase tracking-[0.16em] text-[#2563EB]">Recoverable</div>
                <div className="mt-1 text-lg font-black text-[#2563EB]">{formatMoney(totalRecoverable)}</div>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    {item.recoverableAmount > 0 && (
                      <div className="text-sm font-black text-[#2563EB]">{formatMoney(item.recoverableAmount)}</div>
                    )}
