        ...
        <div className="min-w-[1180px]">
          ...
          {filtered.map((row) => (
            <div key={row.id} className="grid grid-cols-10 items-center border-t border-slate-100 px-5 py-5 text-sm">
              ...
              <div className="font-black text-emerald-700">{Number(row.actual_gp || 0).toFixed(1)}%</div>
              ...
              <div>
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-2 text-xs font-black text-emerald-700"
                >
                  <Zap size={14} />
