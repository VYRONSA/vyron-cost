    ...
    >
      <section className="grid gap-6">
        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(11,32,43,0.06)]">
          ...
          <div className="mt-3 text-4xl font-black text-[#163A48]">{formatSupplierSpend(totalSaving)}</div>
        </div>
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(11,32,43,0.06)]">
        ...
        <div className="rounded-[2rem] bg-[#061722] p-6 text-white shadow-[0_18px_55px_rgba(6,20,14,0.24)]">
          <div className="text-xs font-black uppercase tracking-[0.16em] text-[#2C5A6B]">Rule</div>
        ...
        {benchmarks.map((row) => (
          <Link key={row.id} href={row.href} className="grid grid-cols-7 items-center border-t border-slate-100 px-5 py-5 text-sm transition hover:bg-[#2C5A6B]/10">
            ...
            <div className="font-black text-[#163A48]">{formatSupplierSpend(row.saving)}</div>
