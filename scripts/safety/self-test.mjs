...
check("register holds 82 assets", all.length === 82, String(all.length));
check("73 validation assets", counts.A + counts.B + counts.C + counts.D === 73, String(counts.A + counts.B + counts.C + counts.D));
