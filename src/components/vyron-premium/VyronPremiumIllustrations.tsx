...
export function VyronPremiumMiniChartIcon() {
  return (
    <svg viewBox="0 0 80 80" className="h-20 w-20" aria-hidden>
      ...
      <path d="M10 44 Q30 20 48 34 T74 16" stroke="#60a5fa" strokeWidth="3" fill="none" />
    </svg>
  );
}
...
export function VyronPremiumMiniCalculatorIcon() {
  return (
    <svg viewBox="0 0 80 80" className="h-20 w-20" aria-hidden>
      ...
      <rect x="10" y="8" width="60" height="64" rx="14" fill="url(#calcGradRealImages)" stroke="#60a5fa" strokeWidth="2" />
