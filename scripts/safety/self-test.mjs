...
check("register holds 85 assets", all.length === 85, String(all.length));
check("76 validation assets", counts.A + counts.B + counts.C + counts.D === 76, String(counts.A + counts.B + counts.C + counts.D));
