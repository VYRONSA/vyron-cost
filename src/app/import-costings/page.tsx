...
export default function ImportCostingsPage() {
  ...
  return (
    ...
    >
      <section className="mb-6 rounded-[2rem] bg-[#061722] p-7 text-white shadow-[0_18px_55px_rgba(6,20,14,0.24)]">
        ...
        <div className={`mt-6 inline-flex rounded-full px-4 py-2 text-xs font-black uppercase tracking-[0.16em] ${ready ? "bg-[#2C5A6B]/12 text-[#2C5A6B]" : "bg-blue-400/20 text-blue-200"}`}>
          {ready
      ...
      <section className="mb-6 rounded-[2rem] border border-white bg-white p-7">
        <h3 className="text-xl font-black text-[#061722]">Required files</h3>
        ...
        <pre className="mt-6 overflow-x-auto rounded-2xl bg-slate-900 p-4 text-sm text-[#2C5A6B]">
          {`cd vyron-cost-web
...
npm run import:handcrafted`}
      ...
      <section className="mt-6 rounded-[2rem] border border-white bg-white p-7 shadow-[0_10px_40px_rgba(11,32,43,0.07)]">
        <div className="flex items-start gap-4">
          <div className="rounded-2xl bg-[#2C5A6B]/10 p-3 text-[#163A48]">
            <Upload />
          </div>
          <div>
            <h3 className="text-2xl font-black text-[#061722]">What gets created</h3>
