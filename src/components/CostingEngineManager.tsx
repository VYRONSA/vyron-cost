      ...
      <div className="rounded-[2rem] border border-white bg-white p-6 shadow-[0_10px_40px_rgba(11,32,43,0.06)]">
        ...
        <div className="grid gap-4">
          <label className="text-sm font-black text-slate-600">
            Recipe
            <select className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3 font-medium outline-none focus:border-blue-400" value={recipeId} onChange={(event) => setRecipeId(event.target.value)}>
          ...
          <label className="text-sm font-black text-slate-600">
            Ingredient
            <select className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3 font-medium outline-none focus:border-blue-400" value={ingredientId} onChange={(event) => setIngredientId(event.target.value)}>
