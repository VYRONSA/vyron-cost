...
export default function Page() {
  return (
    ...
    >
      ...
      <section className="mt-8 rounded-[2rem] border border-white/70 bg-white/90 p-8 shadow-[0_18px_60px_rgba(30,58,138,0.08)]">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-4">
          ...
          <Link href="/manufacturing/finished-goods" className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-white p-5 text-sm font-black text-blue-800 transition hover:border-blue-200 hover:shadow-md">
            Finished Goods
          </Link>
          <Link href="/inventory/counts" className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-white p-5 text-sm font-black text-blue-800 transition hover:border-blue-200 hover:shadow-md">
            Stock Counts
          </Link>
          <Link href="/inventory/ledger" className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-white p-5 text-sm font-black text-blue-800 transition hover:border-blue-200 hover:shadow-md">
            Stock Ledger
          </Link>
        </div>
      </section>
