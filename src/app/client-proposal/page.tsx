...
export default function Page() {
  return (
    <VyronCostAiShell hidePageHeader title="Client Proposal" subtitle="Simple proposal language for a prospect.">
      <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_18px_50px_rgba(22,58,72,0.08)]">
          ...
          <p className="mt-3 text-sm font-semibold leading-7 text-slate-600">VOLORA creates a live costing and profit intelligence platform across products, suppliers and invoices.</p>
        </div>
