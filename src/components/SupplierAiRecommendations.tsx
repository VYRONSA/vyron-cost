  ...
  return (
    <section className="mt-6 rounded-[2rem] border border-blue-100 bg-gradient-to-br from-blue-50 to-white p-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <div className="text-xs font-black uppercase tracking-[0.14em] text-blue-600">AI Procurement Manager</div>
        ...
        {recs.slice(0, 5).map((r) => (
          <li key={r.recommendation_key}>
            <Link
              ...
              className="block rounded-xl bg-white p-4 shadow-sm transition hover:border-blue-200 border border-transparent"
            >
