            ...
            <div className="rounded-[2rem] border border-white bg-white p-7 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
              ...
              <div className="grid gap-5">
                ...
                <div className="flex flex-wrap gap-3">
                  <button type="button" onClick={saveRecipe} className="inline-flex items-center gap-2 rounded-2xl border border-[#A3E635]/30 bg-[#24183F] px-6 py-4 text-sm font-black text-[#F8FAFC] transition hover:bg-[#2a2448]">
                    <Save size={18} />
                    Save Recipe
                  </button>
