            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <h2 className="text-xl font-black text-[#07110d]">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-black text-[#07110d] transition hover:bg-emerald-400"
              >
