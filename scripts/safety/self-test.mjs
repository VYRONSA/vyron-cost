...
check("register holds 83 assets", all.length === 83, String(all.length));
check("74 validation assets", counts.A + counts.B + counts.C + counts.D === 74, String(counts.A + counts.B + counts.C + counts.D));
