...
export default function Page() {
  return (
    <VyronCostAiShell hidePageHeader title="Pilot Setup Plan" subtitle="A focused pilot plan to get the first client live quickly.">
      <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_18px_50px_rgba(22,58,72,0.08)]">
          ...
          <p className="mt-3 text-sm font-semibold leading-7 text-slate-600">Compare VOLORA calculations to current costing sheets.</p>
        </div>
