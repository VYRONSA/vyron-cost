    ...
    <section className="grid gap-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-2xl bg-white p-5 shadow-sm">
          ...
          <div className={`mt-2 text-2xl font-black ${dashboard.byPeriod[period].actual > dashboard.byPeriod[period].budget ? "text-red-600" : "text-emerald-600"}`}>
          ...
          <tbody>
            {rows.map((r) => (
              <tr key={r.id} className="border-t border-slate-100">
                ...
                <td className={`p-4 font-bold ${r.variance > 0 ? "text-red-600" : "text-emerald-600"}`}>{money(r.variance)}</td>
