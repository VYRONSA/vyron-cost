    ...
    <svg viewBox="0 0 80 80" className="h-20 w-20" aria-hidden>
      <defs>
        <linearGradient id="miniChartRealImages" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#1f4757" />
          <stop offset="0.5" stopColor="#5f8595" />
      ...
      <path d="M10 44 Q30 20 48 34 T74 16" stroke="#5f8595" strokeWidth="3" fill="none" />
    </svg>
  );
}
    ...
    <svg viewBox="0 0 80 80" className="h-20 w-20" aria-hidden>
      <defs>
        <linearGradient id="calcGradRealImages" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#0f2d39" />
          <stop offset="0.55" stopColor="#101a33" />
          <stop offset="1" stopColor="#2c5a6b" />
        </linearGradient>
      </defs>
      <rect x="10" y="8" width="60" height="64" rx="14" fill="url(#calcGradRealImages)" stroke="#5f8595" strokeWidth="2" />
