  ...
  return (
    <VyronPremiumPageShell
      config={{
        ...
        subtitle: "Premium VOLORA workflow for market readiness dashboard.",
      ...
      <section className="grid gap-6">
            <div className="grid gap-5 md:grid-cols-3">
              {items.map(([label, value, href]) => (
                <Link key={label} href={href} className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(11,32,43,0.06)] transition hover:bg-[#2C5A6B]/10">
            ...
            <div className="rounded-[2rem] bg-[#061722] p-6 text-white">
              ...
              <p className="mt-4 text-sm font-semibold leading-7 text-slate-300">
                VOLORA is positioned as an AI Profit Recovery & Cost Intelligence Platform for food manufacturers, not just a costing calculator.
              </p>
            </div>
          </section>
    </VyronPremiumPageShell>
