  ...
  return (
    <section className="grid gap-6 xl:grid-cols-[0.75fr_1.25fr]">
      <div className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
        <h2 className="text-2xl font-black text-[#07110d]">Simulator</h2>
      ...
      <div className="rounded-[2rem] bg-[#07110d] p-6 text-white shadow-[0_18px_55px_rgba(6,20,14,0.24)]">
        <div className="text-xs font-black uppercase tracking-[0.16em] text-emerald-300">Stock Impact</div>
        <div className="mt-6 grid gap-5 md:grid-cols-3">
          ...
          <div className="rounded-3xl bg-white/10 p-5">
            ...
            <div className="mt-2 text-3xl font-black text-emerald-300">{money(annual)}</div>
          </div>
        </div>
      </div>
    </section>
