    ...
    <section className="grid gap-6">
      <section className="grid gap-5 md:grid-cols-4">
        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
          ...
          <div className="mt-3 text-4xl font-black text-amber-600">{belowTarget}</div>
        </div>
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
          <div className="text-xs font-black uppercase tracking-[0.16em] text-slate-400">Average GP</div>
          <div className="mt-3 text-4xl font-black text-emerald-700">{avgGp.toFixed(1)}%</div>
        </div>
        <div className="rounded-[2rem] bg-emerald-50 p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
          <div className="text-xs font-black uppercase tracking-[0.16em] text-emerald-700">Price Headroom</div>
          <div className="mt-3 text-4xl font-black text-emerald-700">{money(suggestedIncrease)}</div>
        </div>
      </section>
      ...
      <div className="overflow-x-auto rounded-[2rem] bg-white shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
        <div className="min-w-[1180px]">
          <div className="grid grid-cols-10 bg-[#07110d] px-5 py-4 text-xs font-black uppercase tracking-[0.16em] text-emerald-300">
          ...
          {filtered.map((row) => (
            <Link
              ...
              className="grid grid-cols-10 items-center border-t border-slate-100 px-5 py-5 text-sm transition hover:bg-emerald-50"
            >
              ...
              <div className="font-black text-[#07110d]">{Number(row.actual_gp || 0).toFixed(1)}%</div>
              ...
              <div className="font-black text-emerald-700">{money(row.suggested_price)}</div>
      ...
      <div className="rounded-[2rem] bg-[#07110d] p-6 text-white shadow-[0_18px_55px_rgba(6,20,14,0.24)]">
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          ...
          <Link href="/products" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-5 py-4 text-sm font-black text-[#07110d]">
