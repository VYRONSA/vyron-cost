  ...
  return (
    <section className="grid gap-6">
        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_18px_50px_rgba(81,63,190,0.08)]">
          ...
          <dl className="mt-4 grid gap-4 text-sm sm:grid-cols-2">
            ...
            <div>
              ...
              <dd className="mt-1 font-bold text-emerald-700">{procurementMoney(recommendation.potential_benefit_annual)}/yr</dd>
            </div>
            <div>
      ...
      <div className="rounded-[2rem] bg-emerald-50 p-6">
        ...
        <p className="mt-2 text-sm font-bold text-emerald-950">{recommendation.recommended_action}</p>
      </div>
