  ...
  return (
    ...
    >
      <section className="grid gap-6">
            <div className="rounded-[2.5rem] border border-[#3B82F6]/25 bg-[#07110d] p-8 text-white">
              <div className="text-xs font-black uppercase tracking-[0.25em] text-[#3B82F6]">Demo scenario</div>
            ...
            <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
              <div className="rounded-[2rem] border border-white bg-white p-6 shadow-sm">
                ...
                <div className="mt-2 flex items-center gap-2 text-3xl font-black text-[#1D4ED8]">
                  <TrendingUp size={22} />
              ...
              <div className="rounded-[2rem] bg-[#07110d] p-6 text-white">
                <div className="text-xs font-black uppercase tracking-[0.2em] text-[#3B82F6]">Suggested Price</div>
            ...
            <div className="rounded-[2rem] border border-white bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
              <div className="text-xs font-black uppercase tracking-[0.2em] text-[#1D4ED8]">Products affected</div>
              <div className="mt-4 flex flex-wrap gap-3">
                {scenario.productsAffected.map((product) => (
                  <span key={product} className="rounded-full border border-[#3B82F6]/25 bg-[#3B82F6]/10 px-4 py-2 text-sm font-black text-[#4D7C0F]">
                    {product}
                  </span>
                ))}
              </div>
              <Link
                ...
                className="mt-6 inline-flex rounded-full bg-[#07110d] px-5 py-3 text-xs font-black uppercase tracking-[0.14em] text-[#3B82F6]"
              >
