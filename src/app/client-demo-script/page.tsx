...
export default function Page() {
  return (
    <VyronCostAiShell hidePageHeader title="Client Demo Script" subtitle="Exact words and flow to use when presenting VOLORA.">
      <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_18px_50px_rgba(22,58,72,0.08)]">
          ...
          <p className="mt-3 text-sm font-semibold leading-7 text-slate-600">Most businesses know what they sell for, but not what every product truly costs today. VOLORA connects suppliers, ingredients, BOMs, products, purchase orders and invoices to protect profit.</p>
        </div>
