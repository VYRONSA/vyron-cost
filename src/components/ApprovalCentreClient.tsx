            ...
            <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-3 text-xl font-black text-[#07110d]">
                    {approval.title}
                  </h2>
                  ...
                  <div className="mt-4 grid gap-3 md:grid-cols-3">
                    ...
                    <div className="rounded-2xl bg-[#07110d] px-4 py-3 text-white">
                      <div className="text-xs font-black uppercase tracking-[0.16em] text-emerald-300">Impact</div>
              ...
              {approval.status === "Pending" && (
                <div className="flex flex-wrap gap-3">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-black text-[#07110d]"
                  >
