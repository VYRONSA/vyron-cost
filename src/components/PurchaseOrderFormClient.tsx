    ...
    <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
      <div className="rounded-[2rem] border border-white bg-white p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-2xl font-black text-[#07110d]">{mode === "create" ? "Create Purchase Order" : "Edit Purchase Order"}</h2>
          <Link href="/purchase-orders" className="text-sm font-black text-emerald-700">
            Back to register
          </Link>
        </div>
        ...
        <div className="mt-6">
          <div className="mb-3 flex items-center justify-between">
            ...
            <button type="button" onClick={addLine} className="rounded-full bg-emerald-50 px-4 py-2 text-xs font-black text-emerald-700">
              + Add line
            </button>
          </div>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <button type="button" onClick={savePo} className="inline-flex items-center gap-2 rounded-2xl bg-emerald-500 px-6 py-4 text-sm font-black text-[#07110d]">
            <Save size={18} />
            Save PO
          </button>
          {mode === "edit" ? (
