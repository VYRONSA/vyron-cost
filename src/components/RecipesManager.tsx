    ...
    <section className="grid gap-6 xl:grid-cols-[0.8fr_1.5fr]">
      <div className="rounded-[2rem] border border-white bg-white p-6 shadow-[0_10px_40px_rgba(11,32,43,0.06)]">
        ...
        <div className="grid gap-4">
          ...
          <button type="button" onClick={addRecipe} className="inline-flex items-center justify-center gap-2 rounded-2xl border border-transparent vyron-grad-surface px-5 py-4 text-sm font-black text-[#F8FAFC] transition hover:bg-[#163a48]">
            <Plus size={18} />
            Add Recipe
          </button>
              ...
              return (
                <div key={recipe.id} className="grid grid-cols-8 items-center border-t border-slate-100 px-5 py-5 text-sm">
                  <div className="col-span-2">
                    <Link href={`/recipes/${recipe.id}`} className="font-black text-[#F8FAFC] hover:text-[#163A48]">
                      {recipe.recipe_name}
                    </Link>
                  ...
                  <div>
                    <Link href={`/recipes/${recipe.id}/edit`} className="inline-flex items-center gap-2 rounded-full border border-[#2C5A6B]/25 bg-[#2C5A6B]/10 px-3 py-2 text-xs font-black text-[#163A48]">
                      <Edit3 size={14} />
                      Edit
                    </Link>
                  </div>
