    ...
    >
      <section className="grid gap-6">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          ...
          <div className="rounded-[2rem] bg-[#2C5A6B]/10 p-5">
            <b>Total</b>
            <div className="text-3xl font-black text-[#55B968]">{formatMoney(totals.total)}</div>
          </div>
        </div>

        {dup ? <div className="rounded-2xl bg-red-50 p-4 font-bold text-red-700">Duplicate risk detected.</div> : null}
        {msg ? <div className="rounded-2xl border border-[#2C5A6B]/20 bg-[#2C5A6B]/10 p-4 font-bold text-[#163A48]">{msg}</div> : null}
                ...
                return (
                  ...
                  >
                    ...
                    <input
                      ...
                      className="rounded-xl border px-2"
                    />
                    <div className={variance > 5 ? "text-right font-black text-red-600" : "text-right font-black text-[#55B968]"}>
                      {variance.toFixed(1)}%
                    </div>
