          ...
          {filteredTemplates.map((item) => (
            <button
              ...
              className={`block w-full rounded-2xl border px-4 py-3 text-left transition ${
                selected === item.id ? "border-[#5F8595] bg-[#2C5A6B]/10" : "border-slate-100 bg-slate-50 hover:bg-white"
              }`}
            >
        ...
        <div className="rounded-[2rem] border border-white bg-white p-6 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl vyron-grad-deep px-4 py-3 text-xs font-black text-[#BCCDD5]"
            >
              <Download size={16} />
          ...
          {canImports ? (
            <label className="mt-6 flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 px-6 py-10 transition hover:border-[#5F8595]">
              <Upload size={28} className="text-[#163A48]" />
          ...
          {validationMessage ? (
            <div className="mt-4 rounded-xl border border-[#2C5A6B]/20 bg-[#2C5A6B]/10 px-4 py-3 text-sm font-black text-[#2F7C40]">{validationMessage}</div>
          ) : null}
