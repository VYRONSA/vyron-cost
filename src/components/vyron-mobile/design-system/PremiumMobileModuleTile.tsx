    ...
    <Link href={href} className={`${MOBILE_TYPOGRAPHY.family} block`}>
      <PremiumMobileCard tone="raised" pressable className="group relative overflow-hidden p-4">
        ...
        <div className="relative flex items-start justify-between gap-3">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl vyron-grad-surface text-white shadow-[0_12px_25px_rgba(6,23,34,0.2)] transition-transform duration-200 group-hover:scale-105">
