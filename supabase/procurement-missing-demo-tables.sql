-- VYRON COST — Procurement & demo prerequisites (missing on partial installs)
-- Safe to re-run. Run BEFORE: vyron-cost-demo-full-business-cycle.sql
-- Creates tables normally added by procurement-batch-b, document-ai, inventory, recovery, AI procurement.
