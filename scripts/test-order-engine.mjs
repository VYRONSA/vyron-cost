...
const seed = () => ({
  ...
  // The synthetic tenant's web stores are recorded as activated so orders can
  // arrive. FICTIONAL FIXTURE: no person activated these. A channel is never
  ...
  vyron_order_channel_settings: ["store-a", "store-other"].map((key, i) => ({
    ...
    activation_state: "ACTIVE", activated_at: "2026-09-01T00:00:00Z", activated_by: "FICTIONAL-TEST-FIXTURE (not a person)",
    uat_passed_at: "2026-08-31T00:00:00Z", uat_reference: "FICTIONAL-TEST-FIXTURE (no real UAT run)",
